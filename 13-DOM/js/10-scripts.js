...
// Vamos a crear un nuevo enlace... lo primero que hay que hacer es crear el elemento HTML, en este caso un enlace puede ser en mayusculas o minusculas
...
//Aqui lo ponemos sobre navegacion 
const navegacion = document.querySelector('.navegacion');
navegacion.appendChild(enlace);
//navegacion.insertBefore(enlace, navegacion.children[1]); //esto tambien sirve solo que pone antes de
console.log(enlace);
...
parrafo1.textContent = 'HTML made by JS';
parrafo1.classList.add('categoria');
parrafo1.classList.add('concierto');

// Segundo parrafo
const parrafo2 = document.createElement('P');
parrafo2.textContent = 'HTML make with JS';
parrafo2.classList.add('titulo');

// 3er parrafo...
const parrafo3 = document.createElement('p');
// parrafo3.textContent = '$800 por persona ';
parrafo3.textContent = 'HTML generado con JS';
