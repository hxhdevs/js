...
const resultado = segundoNumero(3);//esta forma seria mas engorrosa ya que esta pasando argumentos y reasignado y puede resultar algo confusa
console.log(resultado);

// Esta opción seria de forma mas simplificada de hacer que se ejcute el curryng
