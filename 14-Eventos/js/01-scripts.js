...
console.log(1)
    document.addEventListener('DOMContentLoaded', () => {//esto se ejecuta una vez que se carga todo el HTML
        console.log(2);
    }) // Nota todos los eventos que hay disponibles
console.log(3);
// Al ultimo se ejecuta el Listener como empieza de arriba hacia abajo y da dos vueltas
//checar esto en consola